...
const toDoFormTitleDOM = toDoFormDOM[1].childNodes[3];
const toDoFormDescriptionDOM = toDoFormDOM[3].childNodes[3];
const toDoFormDueDateDOM = toDoFormDOM[5].childNodes[3];
const toDoFormPriorityDOM = toDoFormDOM[7];
...
const toDoFormNotesDOM = toDoFormDOM[9].childNodes[3];
const toDoFormProjectDOM = toDoFormDOM[11].childNodes[3];
const toDoFormStatusDOM = toDoFormDOM[13];
...
const toDoFormSubmitButtonDOM = toDoFormDOM[17];
